...
const CreatedRideHistory = () => {
    ...
    const {
        ...
        isPending: isCompleteRidePending
    } = useMutation(
        {
            mutationFn: ( rideId: string ) => {
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                                            <div className="flex items-center">
                                                ...
                                                <p className="font-medium">{ride.startingLocation?.name}</p>
                                            </div>
                                            <span className="hidden sm:inline mx-1">→</span>
                                            <div className="flex items-center">
                                                <MapPin className="h-4 w-4 text-red-400 mr-1" />
                                                <p className="font-medium">{ride.destinationLocation?.name}</p>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <p className="text-sm font-medium truncate">{booking.user.name || booking.user.email}</p>
                                                            <Badge
