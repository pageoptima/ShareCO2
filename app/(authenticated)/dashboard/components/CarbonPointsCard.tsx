...
import { rupeesToCarbonPoints, RUPEES_PER_CARBON_POINT, formatCarbonPointsForUI } from "@/utils/carbonPointsConversion";
...
export function CarbonPointsCard() {
    ...
    const {
        mutateAsync: mutateRequestTopup,
        isPending: isRequestTopupPending
    } = useMutation(
        {
            ...
            <Card className="bg-[#1A3C34] text-white border-none">
                <CardContent className="space-y-4">
                    <div>
                        ...
                        <p className="text-2xl font-semibold text-center">{carbonPoint} CP</p>
                    </div>
                    <Button
