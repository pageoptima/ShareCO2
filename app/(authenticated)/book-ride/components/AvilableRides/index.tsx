                            ...
                            >
                                        ...
                                        <CardTitle className="text-base sm:text-lg font-medium flex items-center">
                                            <div className="flex flex-col sm:flex-row sm:items-center gap-1 w-full">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="text-white/90 truncate">{ride.startingLocationName}</span>
                                                </div>
                                                <span className="hidden sm:inline mx-1">→</span>
                                                <div className="flex items-center">
                                                    <MapPin className="h-4 w-4 text-red-400 mr-1 flex-shrink-0" />
                                                    <span className="text-white/90 truncate">{ride.destinationLocationName}</span>
                                                </div>
                                            </div>
                                        </CardTitle>
                                    </div>
                                ...
                                <CardContent className="p-4">
                                    ...
                                    <Button
                                        ...
                                        variant="default"
                                        size="sm"
                                        className={`w-full justify-center ${!hasSeats
