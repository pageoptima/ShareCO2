        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center text-sm">
            ...
            <span className="truncate">
              ...
              {isUserOwned
                ? "You"
                : rideRequest.user.name || rideRequest.user.email}
            </span>
          </div>
          ...
          <div className="pt-2">
            ...
            {isUserOwned && rideRequest.status !== "Pending" && (
              <Badge
                variant="outline"
                className="bg-emerald-500/20 text-emerald-300 border-emerald-500/30 w-full justify-center py-2"
              >
