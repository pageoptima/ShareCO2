...
export async function generateWeeklyDriverRankings(): Promise<Buffer> {
    ...
    return generateCsvBuffer("weekly_driver_rankings", rankings);
}

export async function generateWeeklyRiderRankings(): Promise<Buffer> {
    const lastWeekStart = new Date();
    lastWeekStart.setDate(lastWeekStart.getDate() - 7);
    lastWeekStart.setHours(0, 0, 0, 0);
    ...
    return generateCsvBuffer("weekly_rider_rankings", rankings);
}

export async function generateLifetimeUserRankings(): Promise<Buffer> {
    ...
    return generateCsvBuffer("lifetime_user_rankings", rankings);
}
